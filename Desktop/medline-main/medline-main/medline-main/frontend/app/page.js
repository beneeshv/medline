  ...
  return (
    <main className="relative min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full h-[600px] flex items-center justify-start overflow-hidden">
        {/* Background Image - Apollo Hospital themed */}
        <img
          src="https://img.freepik.com/free-photo/hospital-building-modern-parking-lot_1127-3822.jpg?w=2000" // Apollo Hospital themed image
          alt="Apollo Hospital Building"
          className="absolute inset-0 w-full h-full object-cover" 
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--apollo-primary)]/90 via-[var(--apollo-primary)]/70 to-transparent"></div> {/* Apollo gradient overlay */}
        ...
        <div className="relative z-10 text-white text-left pl-20 w-1/2">
          ...
          <p className="text-lg text-white/90 mb-8">
            Apollo Hospital is committed to providing exceptional healthcare services with cutting-edge technology and compassionate care for all patients.
          </p>
          <a
      ...
      <div className="py-16 px-6 bg-[var(--apollo-light)]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-[var(--apollo-primary)]">Why Choose Apollo Hospital</h2>
