  ...
  return (
    <header>
      ...
      <div className="apollo-gradient text-white text-xs py-2 px-6 flex justify-between items-center">
        <span>Apollo Hospital - Excellence in Healthcare</span>
      ...
      <nav className="bg-white shadow-md py-4 px-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <Link href="/" className="text-[var(--apollo-primary)] text-2xl font-bold">Apollo Hospital</Link>
        </div>
        <ul className="flex space-x-8 text-gray-700 font-medium items-center">
          ...
          <li>
            <Link href="/user/bills" className="hover:text-[var(--apollo-primary)]">
              BILLS
            </Link>
          </li>
          <li>
