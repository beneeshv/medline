...
export default function AddDoctor() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // No authentication needed since backend has AllowAny permission
        ...
        <div className="flex min-h-screen bg-gray-100 font-inter">
            ...
            <main className="flex-1 p-8">
                <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-xl">
                    {/* Changed text-gray-800 to text-black for the main heading */}
                    <h1 className="text-3xl font-bold text-black mb-6 text-center">Add a New Doctor</h1>
                    {message && (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            {/* Changed text-gray-700 to text-gray-900 (near-black) for labels */}
                            <label htmlFor="name" className="block text-sm font-medium text-gray-900 mb-1">Doctor Name</label>
                            <input
                                id="name"
                                name="name"
                                type="text"
                                ...
                                className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                                required
                            />
                        </div>
                        <div>
                            {/* Changed text-gray-700 to text-gray-900 for labels */}
                            <label htmlFor="specialization" className="block text-sm font-medium text-gray-900 mb-1">Specialization</label>
                            <select
                                id="specialization"
                                name="specialization"
                        ...
                        <div>
                            {/* Changed text-gray-700 to text-gray-900 for labels */}
                            <label htmlFor="number" className="block text-sm font-medium text-gray-900 mb-1">Phone Number</label>
                            <input
                                id="number"
                                name="number"
                                type="tel"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 resize-y text-gray-900"
                                rows="3"
                                required
                            ></textarea>
                        </div>
                        <div>
                            {/* Changed text-gray-700 to text-gray-900 for labels */}
                            <label htmlFor="availability" className="block text-sm font-medium text-gray-900 mb-1">Availability (JSON Format)</label>
                            <textarea
                                id="availability"
                                name="availability"
                        ...
                        <div>
                            {/* Changed text-gray-700 to text-gray-900 for labels */}
                            <label htmlFor="image" className="block text-sm font-medium text-gray-900 mb-1">Profile Image</label>
                            <input
                                id="image"
                                type="file"
                                name="image"
                                onChange={handleChange}
                                className="w-full p-3 bg-gray-50 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                            />
                        </div>
                        <button
                            type="submit"
