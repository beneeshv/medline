...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://img.freepik.com/free-photo/hospital-building-modern-parking-lot_1127-3822.jpg?w=800&q=80')",
      }}
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md p-8 rounded-xl shadow-2xl bg-white/30 backdrop-blur-md text-center">
        <div className="mb-6">
          <h1 className="text-white text-5xl font-bold">Medline</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 mt-4 bg-teal-600 hover:bg-teal-700 text-white font-bold text-lg rounded-full transition duration-300 shadow-lg hover:shadow-teal-500/30"
            disabled={loading}
          >
            {loading ? (
